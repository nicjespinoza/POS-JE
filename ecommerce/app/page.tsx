...
import { ShoppingBag, ArrowRight, Star, TrendingUp, Zap } from 'lucide-react';

const MOCK_PRODUCTS = [
  { id: 1, name: 'Nike Air Zoom Alpha', price: 189.99, category: 'Running', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?q=80&w=2070&auto=format&fit=crop' },
  { id: 2, name: 'Adidas Ultraboost DNA', price: 160.00, category: 'Lifestyle', image: 'https://images.unsplash.com/photo-1551107696-a4b0c5a0d9a2?q=80&w=2012&auto=format&fit=crop' },
  { id: 3, name: 'Puma RS-X Tech', price: 110.00, category: 'Sportstyle', image: 'https://images.unsplash.com/photo-1608231387042-66d1773070a5?q=80&w=1974&auto=format&fit=crop' },
];
...
export default function Home() {
  return (
    <div className="min-h-screen bg-black text-white selection:bg-purple-500/30">
      ...
      {/* Navbar (Simple Mock) */}
      <nav className="fixed w-full z-50 px-6 py-4 glass bg-black/50">
