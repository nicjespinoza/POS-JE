...
import { getProfitAndLoss, getInventoryValuation, getMonthlyPnL, getInventoryValuationFast, analyzeFinancialHealth, ReportPnL } from '../../services/reportingService';
import {
    DollarSign,
    TrendingUp,
    TrendingDown,
...
export const ReportsDashboard: React.FC = () => {
    ...
    const fetchReports = async () => {
        ...
        try {
            ...
            // [SCALABILITY] Use pre-aggregated P&L for full-month queries (1 read)
            ...
            if (isFullMonth) {
                pnlData = await getMonthlyPnL(start.getFullYear(), start.getMonth() + 1);
            } else {
