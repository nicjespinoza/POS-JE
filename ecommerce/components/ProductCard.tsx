            ...
            <Link href={`/product/${id}`} className="block">
                <div className="aspect-[4/5] rounded-3xl overflow-hidden bg-gray-900 relative mb-4">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                        <span className="w-full py-3 bg-white text-black font-bold rounded-xl translate-y-4 group-hover:translate-y-0 transition-transform duration-300 flex items-center justify-center gap-2">
                            <ShoppingBag size={18} /> Ver Detalles
                        </span>
                    </div>
