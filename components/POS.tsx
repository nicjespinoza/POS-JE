                ...
                {categories.map(cat => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-4 py-2 rounded-xl text-sm font-medium whitespace-nowrap transition-all ${isSelected
              ...
              <div className="w-full md:w-1/2 p-8 flex flex-col relative">
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex justify-between items-center p-4 rounded-xl bg-gray-50 dark:bg-white/5">
                    ...
                    <span className={`font-bold ${viewingProduct.stock <= 0 ? 'text-red-500' :
                ...
                <div className="grid grid-cols-3 gap-2">
                  {['compact', 'normal', 'comfortable'].map((d) => (
                    <button
                      ...
                      className={`py-2 px-3 rounded-lg text-xs font-medium border transition-colors capitalize ${layoutConfig.density === d
