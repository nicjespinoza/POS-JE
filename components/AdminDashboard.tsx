...
import { 
  ...
  Wallet, Sun, Moon, ChevronDown, Filter, X, Settings, Plus, Trash2, Edit2, Check, Save, Globe, Shield, Users, CheckSquare, Square, BarChart, ArrowUp, ArrowDown, ShoppingBag, Package, CheckCircle2, Percent, Box, Calendar, Tag, CreditCard, Banknote, Landmark, Smartphone, Mail, FileText, Search, LayoutDashboard
} from 'lucide-react';
                                ...
                                <tr key={product.id} className="border-b border-gray-100 dark:border-white/5 last:border-0 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                    ...
                                    <td className="py-3 px-4 text-center">
                                        <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                                            product.stock <= 0 ? 'bg-red-100 text-red-700 dark:bg-red-500/20 dark:text-red-400' :
